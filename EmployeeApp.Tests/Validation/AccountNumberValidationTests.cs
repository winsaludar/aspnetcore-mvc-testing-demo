...
public class AccountNumberValidationTests
{
    ...
    [Fact]
    public void IsValid_ValidAccountNumber_ReturnsTrue() => Assert.True(_validation.IsValid("123-4543234576-23"));
    ...
    [InlineData("123+345456567633-23")]
    [InlineData("123+345456567633=23")]
    public void IsValid_InvalidDelimiters_ThrowsArgumentException(string accountNumber) => Assert.Throws<ArgumentException>(() => _validation.IsValid(accountNumber));
}
